...
const ERC721Transfers = require("../models/ERC721Transfers-hyperspace");
const ERC721 = require("@openzeppelin/contracts/build/contracts/ERC721.json");

const getHyperspaceNFTs = async () => {
          ...
          provider.on(filter, async (log, event) => {
            try {
              if (log.topics.length === 4) {
                ...
                console.log("Updating entry in the Hyperspace database!");
...
module.exports = { getHyperspaceNFTs };